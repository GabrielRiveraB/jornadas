...
class WorksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'responsables' => ['type' => 'string', 'length' => 250, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'folio' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'fecha_compromiso' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'responsables' => 'Lorem ipsum dolor sit amet',
                'folio' => 'Lorem ipsum dolor sit amet',
                'fecha_compromiso' => '2020-01-15',
                'start' => '2020-01-15',
                'end' => '2020-01-15',
                'cost' => 1.5,
                'completed' => 1,
